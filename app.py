...
def get_fitted_font(draw, text, font_path, max_width, max_height, start_size=60):
    """
    Recursively reduces font size until the text fits inside the red box.
    """
    size = start_size
    ...
    while size > 20: 
        try:
            ...
            return font, textwrap.fill(text, width=40) # Return default if system font fails
    ...
    return font, textwrap.fill(text, width=30)
